// Bandera a partir del MID (Maritime Identification Digits): los 3 primeros
// digitos de un MMSI de buque. El AIS no transmite el pais de bandera como tal,
// asi que esto es una derivacion del MMSI, no un dato medido.
//
// La tabla cubre los MIDs asignados de uso habitual. Un MID no listado devuelve
// null -- preferible a adivinar. Ampliala con la lista oficial de la ITU si
// necesitas cobertura total.

const MID_TO_ISO2 = {
  201: 'AL', 202: 'AD', 203: 'AT', 204: 'PT', 205: 'BE', 206: 'BY',
  209: 'CY', 210: 'CY', 211: 'DE', 212: 'CY', 213: 'GE', 214: 'MD',
  215: 'MT', 218: 'DE', 219: 'DK', 220: 'DK', 224: 'ES', 225: 'ES',
  226: 'FR', 227: 'FR', 228: 'FR', 230: 'FI', 231: 'FO', 232: 'GB',
  233: 'GB', 234: 'GB', 235: 'GB', 236: 'GI', 237: 'GR', 238: 'HR',
  239: 'GR', 240: 'GR', 241: 'GR', 242: 'MA', 243: 'HU', 244: 'NL',
  245: 'NL', 246: 'NL', 247: 'IT', 248: 'MT', 249: 'MT', 250: 'IE',
  251: 'IS', 252: 'LI', 253: 'LU', 254: 'MC', 255: 'PT', 256: 'MT',
  257: 'NO', 258: 'NO', 259: 'NO', 261: 'PL', 262: 'ME', 263: 'PT',
  264: 'RO', 265: 'SE', 266: 'SE', 267: 'SK', 268: 'SM', 269: 'CH',
  270: 'CZ', 271: 'TR', 272: 'UA', 273: 'RU', 274: 'MK', 275: 'LV',
  ...
  470: 'AE', 471: 'AE', 473: 'YE', 475: 'YE', 477: 'HK', 478: 'BA',
  ...
  601: 'ZA', 603: 'AO', 605: 'DZ', 608: 'SH', 609: 'BI', 610: 'BJ',
  611: 'BW', 612: 'CF', 613: 'CM', 615: 'CG', 616: 'KM', 617: 'CV',
  619: 'CI', 620: 'KM', 621: 'DJ', 622: 'EG', 624: 'ET', 625: 'ER',
  626: 'GA', 627: 'GH', 629: 'GM', 630: 'GW', 631: 'GQ', 632: 'GN',
  633: 'BF', 634: 'KE', 636: 'LR', 637: 'LR', 638: 'SS', 642: 'LY',
...
/**
 * Bandera (ISO 3166-1 alpha-2) derivada del MMSI, o null si el MID no esta en
 * la tabla o el MMSI no es de un buque (los MMSI de buque son de 9 digitos y
 * empiezan por 2-7; 0/8/9 son grupos, estaciones costeras, SAR, AtoN, etc.).
 */
export function flagFromMmsi(mmsi) {
  const s = String(mmsi ?? '');
  if (!/^[2-7]\d{8}$/.test(s)) return null;
  return MID_TO_ISO2[Number(s.slice(0, 3))] ?? null;
}
